...
public class CreateControlTest {
    ...
    public void shouldReturnDefaultMessagePostRequested() throws Exception {
        ...
        paramsMap.add("name", "Иван");
        paramsMap.add("description", "Куплю ладу-грант. Дорого.");
        this.mockMvc.perform(post("/createSave")
                .params(paramsMap))
                .andDo(print())
                .andExpect(status().is3xxRedirection());
        ArgumentCaptor<Post> argument = ArgumentCaptor.forClass(Post.class);
        verify(posts).save(argument.capture());
        assertThat(argument.getValue().getName(), is("Иван"));
    }
}